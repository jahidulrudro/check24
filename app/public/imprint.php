...
<main role="main">
    ...
    <div class="row single-blog">
        ...
        <p class="single-blog-text">
            <strong>Author: <?php if(isset($_SESSION)) { echo $_SESSION['fullname'];} ?></strong>
        </p>
        <p class="single-blog-text">Addres:<?php if(isset($_SESSION['address'])) { echo $_SESSION['address'];} ?></p>
